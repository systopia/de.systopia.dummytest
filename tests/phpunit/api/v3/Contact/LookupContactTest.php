...
//      ->apply();
  ...
  // Code in this functino is generated by cv php:boot
  // this creates a bootstrap code to have accress to civicrm function
  // (such as civicrm_api3() ).
  // This has to be generated for each environment, since paths/IP etc differ
